...
static void help(int exit_code = 1)
{
  ...
  fprintf(stderr, "  --timing              Instruction timing file [default:NONE]\n");
...
int main(int argc, char** argv)
{
  ...
  const char* timing = DEFAULT_TIMING;
  uint16_t rbb_port = 0;
  bool use_rbb = false;
  unsigned dmi_rti = 0;
  ...
  parser.option(0, "timing", 1, [&](const char* s){timing = s;});
  ...
  sim_t s(isa, priv, varch, timing, nprocs, halted, start_pc, mems, plugin_devices, htif_args,
