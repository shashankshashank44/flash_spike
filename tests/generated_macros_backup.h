...
#define ld_r10_a_upper_20_macro asm volatile (".word 0x7fbeb537")
#define add_r10_r10_imm_a_lower_12_macro asm volatile (".word 0xd1050513")
#define ld_r13_b_upper_20_macro asm volatile (".word 0x7fbeb6b7")
#define add_r13_r13_imm_b_lower_12_macro asm volatile (".word 0xcc068693")
#define ld_r11_c_upper_20_macro asm volatile (".word 0x7fbeb5b7")
#define add_r11_r11_imm_c_lower_12_macro asm volatile (".word 0xc7058593")
#define ld_r28_d_upper_20_macro asm volatile (".word 0x7fbeb737")
#define add_r28_r28_imm_d_lower_12_macro asm volatile (".word 0xc2070713")
...
#define sub_r28_r28_r12_macro asm volatile (".word 0x40c70733")
...
#define vswv_r28_v28_macro asm volatile (".word 0x2076727")
...
#define vredsum_vs_v28_v28_v11_macro asm volatile (".word 0x2b72757")
