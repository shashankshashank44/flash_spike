...
#define ld_r10_m_upper_20_macro asm volatile (".word 0x2a537")
#define add_r10_r10_imm_m_lower_12_macro asm volatile (".word 0x2b850513")
#define ld_r13_v_upper_20_macro asm volatile (".word 0x12a6b7")
#define add_r13_r13_imm_v_lower_12_macro asm volatile (".word 0x2c068693")
#define ld_r28_y_upper_20_macro asm volatile (".word 0x12ae37")
#define add_r28_r28_imm_y_lower_12_macro asm volatile (".word 0xae8e0e13")
...
#define ld_r12_imm_0xfffff_macro asm volatile (".word 0xfffff637")
#define ld_r23_n_upper_20_macro asm volatile (".word 0x29bb7")
#define add_r23_r23_imm_n_lower_12_macro asm volatile (".word 0xc84b8b93")
...
#define add_r6_r0_imm_256_macro asm volatile (".word 0x10000313")
#define vsetvli_r7_r6_e32_macro asm volatile (".word 0x8373d7")
#define ld_r24_t_upper_20_macro asm volatile (".word 0x29c37")
#define add_r24_r24_imm_t_lower_12_macro asm volatile (".word 0xc48c0c13")
...
#define ld_r24_rows_upper_20_macro asm volatile (".word 0x12bc37")
#define add_r24_r24_imm_rows_lower_12_macro asm volatile (".word 0x310c0c13")
#define sub_r24_r24_r12_macro asm volatile (".word 0x40cc0c33")
#define ld_r27_vals_upper_20_macro asm volatile (".word 0x233db7")
#define add_r27_r27_imm_vals_lower_12_macro asm volatile (".word 0xc20d8d93")
#define sub_r27_r27_r12_macro asm volatile (".word 0x40cd8db3")
#define ld_r28_cols_upper_20_macro asm volatile (".word 0x12be37")
#define add_r28_r28_imm_cols_lower_12_macro asm volatile (".word 0xb18e0e13")
#define sub_r28_r28_r12_macro asm volatile (".word 0x40ce0e33")
#define ld_r29_v_upper_20_macro asm volatile (".word 0x12aeb7")
#define add_r29_r29_imm_v_lower_12_macro asm volatile (".word 0x2c0e8e93")
#define sub_r29_r29_r12_macro asm volatile (".word 0x40ce8eb3")
#define ld_r31_y_upper_20_macro asm volatile (".word 0x12afb7")
#define add_r31_r31_imm_y_lower_12_macro asm volatile (".word 0xae8f8f93")
