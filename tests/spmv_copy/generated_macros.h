...
#define add_r10_r10_imm_m_lower_12_macro asm volatile (".word 0x9b050513")
#define ld_r13_v_upper_20_macro asm volatile (".word 0x403a6b7")
#define add_r13_r13_imm_v_lower_12_macro asm volatile (".word 0x9b868693")
#define ld_r28_y_upper_20_macro asm volatile (".word 0x403ee37")
#define add_r28_r28_imm_y_lower_12_macro asm volatile (".word 0x9e0e0e13")
...
#define ld_r12_imm_0xfffff_macro asm volatile (".word 0xfffff637")
#define ld_r23_n_upper_20_macro asm volatile (".word 0x39bb7")
#define add_r23_r23_imm_n_lower_12_macro asm volatile (".word 0xf80b8b93")
...
#define add_r6_r0_imm_256_macro asm volatile (".word 0x10000313")
#define vsetvli_r7_r6_e32_macro asm volatile (".word 0x8373d7")
#define ld_r24_t_upper_20_macro asm volatile (".word 0x39c37")
#define add_r24_r24_imm_t_lower_12_macro asm volatile (".word 0xf28c0c13")
...
#define ld_r24_rows_upper_20_macro asm volatile (".word 0x4042c37")
#define add_r24_r24_imm_rows_lower_12_macro asm volatile (".word 0xa08c0c13")
#define sub_r24_r24_r12_macro asm volatile (".word 0x40cc0c33")
#define ld_r27_vals_upper_20_macro asm volatile (".word 0x8086db7")
#define add_r27_r27_imm_vals_lower_12_macro asm volatile (".word 0xb18d8d93")
#define sub_r27_r27_r12_macro asm volatile (".word 0x40cd8db3")
#define ld_r28_cols_upper_20_macro asm volatile (".word 0x4046e37")
#define add_r28_r28_imm_cols_lower_12_macro asm volatile (".word 0xa10e0e13")
#define sub_r28_r28_r12_macro asm volatile (".word 0x40ce0e33")
#define ld_r29_v_upper_20_macro asm volatile (".word 0x403aeb7")
#define add_r29_r29_imm_v_lower_12_macro asm volatile (".word 0x9b8e8e93")
#define sub_r29_r29_r12_macro asm volatile (".word 0x40ce8eb3")
#define ld_r31_y_upper_20_macro asm volatile (".word 0x403efb7")
#define add_r31_r31_imm_y_lower_12_macro asm volatile (".word 0x9e0f8f93")
