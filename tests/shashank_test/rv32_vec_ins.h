...
#define OP_LIMM (0b0000011)
#define OP_SIMM (0b0100011)
...
#define FUNCT3_LDWI (0b010)
#define FUNCT3_STWI (0b010)
...
#define FUNCT6_ADD (0b000000)
#define FUNCT6_VMV_VS (0b010111)
...
#define LD_SIMM(rd, rs1, imm) (OP_LIMM | (rd << 7) | (FUNCT3_LDWI << 12) | (rs1 << 15) | (imm << 20))

#define ST_SIMM(rs1, imm1, imm2, rs2) (OP_SIMM | (imm1 << 7) | (FUNCT3_STWI << 12) | (rs1 << 15) | (rs2 << 20) | (imm2 << 25))
...
#define VMV_VS(vd, rs1) (OP_V | (vd << 7) | (OP_V_OPIVX << 12) | (rs1 << 15) | (0 << 20) | (1 << 25) | (FUNCT6_VMV_VS << 26))
